...
class GameDetectiveWonFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val args = GameDetectiveWonFragmentArgs.fromBundle(arguments!!)

        val viewModelFactory = GameDetectiveWonViewModelFactory(dataSource, args.gameId)

        val gameSpaceWonViewModel =
            ViewModelProviders.of(
                this, viewModelFactory
            ).get(GameDetectiveWonViewModel::class.java)

        binding.gameDetectiveWonViewModel = gameSpaceWonViewModel
